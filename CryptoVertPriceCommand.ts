...
export class CryptoVertPriceCommand implements ISlashCommand {
	public command = 'cryptoprice';
	public i18nParamsExample = "example_price";
	public i18nDescription = "example_price_description";
	...
	private async invalidUsageHandler(
		...
		await this.sendNotifyMessage(context, modify, CryptoVertStrings.INVALID_COMMAND + CryptoVertStrings.PRICE_USAGE)
	}
